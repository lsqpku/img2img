...
def get_image2(image_path, input_height, input_width,
              resize_height=64, resize_width=64,
              crop=True, grayscale=False):
  image = imread(image_path, grayscale)
  return transform2(image, input_height, input_width,
                   resize_height, resize_width, crop)

def get_image3(image_path, input_height, input_width,
              resize_height=64, resize_width=64,
              crop=True, grayscale=False):
  image = imread(image_path, grayscale)
  return transform3(image, input_height, input_width,
                   resize_height, resize_width, crop)
...
def transform3(image, input_height, input_width,
              resize_height=64, resize_width=64, crop=True, blur=3):
  if crop:
    cropped_image = center_crop(
      image, input_height, input_width,
    ...
    cropped_image = scipy.misc.imresize(image, [16, 16])
    cropped_image = scipy.misc.imresize(cropped_image, [resize_height, resize_width])


  return [ np.array(image)/127.5 - 1., np.array(cropped_image)/127.5 - 1.0]
